export const subscriptionForm = {
  title: "Subscribe to automatic email alerts",
  subtitle:
    "Complete the fields to subscribe to an automatic email alert if somebody finds documents that match with your subscription info. ",
  nameLabel: "Full name on the document",
  namePlaceholder: "John Adam Williams",
  numberPlaceholder: "230.002.931 / AR-00391/221",
  numberLabel: "Document ID / Card number",
